...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Biggerfoot[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
REPOID = 'repository.biggerfootwizard'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://raw.githubusercontent.com/bigfootbeeker/repository.biggerfootwizard/master/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://raw.githubusercontent.com/bigfootbeeker/repository.biggerfootwizard/master/zips/repository.biggerfootwizard/'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLORed]Biggerfootwizard'
